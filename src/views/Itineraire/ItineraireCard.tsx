import '../../style/ItineraireCard.css'

function ItineraireCard({property}) {
	return <div className="itineraire-card">
		<div className="itineraire-card-svg">
			<svg height="80px" width="80px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
				<g>
					<path fill="#ffbe55" d="M311.508,354.916l5.72-11.034c1.816-3.546,3.506-7.029,5.096-10.582c3.117-7.076,5.666-14.261,7.271-21.36
					...
					<path fill="#ffbe55" d="M444.973,261.023c-19.365-32.394-52.515-55.242-90.917-62.669l-136.052-28.684
		...
		<div className="itineraire-card-info">
			{property.villDep} - {property.villArr}
		</div>
		<div className="itineraire-card-action">
			<button>
